...
monster.loot = {
	{id = "gold coin", chance = 45881, maxCount = 67},
	{id = "tattered piece of robe", chance = 4146},
	{id = "parchment (rewritable)", chance = 873},
	{id = "stealth ring", chance = 655},
	{id = "spike sword", chance = 164},
	{id = "red robe", chance = 55}
}
