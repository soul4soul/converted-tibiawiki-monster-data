...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -107, condition = {type = CONDITION_POISON, startDamage = 158, interval = }}
}
...
monster.loot = {
	...
	{id = 15486, chance = 15002},
	{id = 15622, chance = 14554},
	{id = 7618, chance = 4866},
	{id = 2149, chance = 2839},
	{id = 2438, chance = 568}
}
