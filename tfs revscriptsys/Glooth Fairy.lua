...
monster.loot = {
	...
	{id = "glooth injection tube", chance = 15833, maxCount = 3},
	{id = "gold coin", chance = 15833, maxCount = 100},
	{id = "platinum coin", chance = 15833, maxCount = 5},
	{id = "small emerald", chance = 6667, maxCount = 5},
	{id = "great spirit potion", chance = 5833, maxCount = 5},
	{id = "great health potion", chance = 5000, maxCount = 5},
	{id = "great mana potion", chance = 5000, maxCount = 5},
	{id = "glooth axe", chance = 4167},
	{id = "glooth blade", chance = 4167},
	{id = "glooth sandwich", chance = 4167, maxCount = 5},
	{id = "small ruby", chance = 4167, maxCount = 5},
	{id = "bowl of glooth soup", chance = 3333, maxCount = 5},
	{id = "glooth amulet", chance = 3333},
	{id = "glooth cape", chance = 2500},
	{id = "glooth club", chance = 2500},
	{id = "glooth steak", chance = 2500, maxCount = 5},
	{id = "small topaz", chance = 2500, maxCount = 5},
	{id = "gear wheel", chance = 1667},
	{id = "glooth spear", chance = 1667, maxCount = 5},
	{id = "feedbag", chance = 833},
	{id = "heat core", chance = 833},
	{id = "iron ore", chance = 833},
	{id = "red gem", chance = 833},
	{id = "rubber cap", chance = 833},
	{id = "small amethyst", chance = 833, maxCount = 5},
	{id = "small sapphire", chance = 833, maxCount = 5}
}
