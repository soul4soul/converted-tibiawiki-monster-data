...
monster.defenses = {
	defense = 5,
	armor = 10,
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_HEALING, minDamage = 96, maxDamage = 240}
}
...
monster.loot = {
	{id = "helmet of ultimate terror", chance = 80000},
	{id = "incredible mumpiz slayer", chance = 20000}
}
