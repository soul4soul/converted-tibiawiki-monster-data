...
monster.defenses = {
	defense = 5,
	armor = 10,
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_HEALING, minDamage = 47, maxDamage = 118}
}

monster.loot = {
	{id = "glutton's mace", chance = 40000},
	{id = "trousers of the ancients", chance = 20000},
	{id = "meat shield", chance = 40000}
}
