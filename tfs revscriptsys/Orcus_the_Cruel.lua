...
monster.voices = {
	interval = 5000,
	chance = 10,
	{text = "Ocrs will rule!", yell = false}
}
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = 0, maxDamage = -70, range = 5, radius = 1, target = true, shootEffect = CONST_ANI_THROWINGKNIFE}
}
