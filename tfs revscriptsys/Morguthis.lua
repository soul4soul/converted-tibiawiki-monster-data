...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -1000, condition = {type = CONDITION_POISON, startDamage = 54, interval = }}
}
...
monster.summons = {
	{name = "Hero", chance = 15, interval = 2000, max = 3}
}
