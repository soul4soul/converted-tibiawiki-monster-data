...
monster.loot = {
	{id = "gold coin", chance = 87358, maxCount = 55},
	{id = "dragon ham", chance = 79955},
	{id = "frosty heart", chance = 5063},
	{id = "health potion", chance = 558},
	{id = "spellbook of enlightenment", chance = 497}
}
